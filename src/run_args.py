...
data_g.add_arg("vocab_path", type=str, default="src/data_preprocess/config/vocab/spm9998_3.model", help="Vocabulary path.")
...
data_p = ArgumentGroup(parser, "data_preprocess", "Raw Data paths and data preprocess options")
data_p.add_arg("do_preprocessing", bool, True, "Wether to do preprocessing to the raw data.")
data_p.add_arg("-mode", default='', type=str, help='format_to_json or format_to_paddle')
data_p.add_arg("-json_path", default='src/data_preprocess/json_data/', type=str, help='')
data_p.add_arg("-data_path", default='src/data_preprocess/input_data', type=str, help='')
data_p.add_arg("-vocab_path", default='src/data_preprocess/config/vocab/spm9998_3.model', type=str, help='')

data_p.add_arg("-roberta_vocab_file",
                    default='src/data_preprocess/config/bpe/gpt2_bpe/vocab.txt',
                    type=str, help='')
data_p.add_arg("-encoder_json_file",
                    default='src/data_preprocess/config/bpe/gpt2_bpe/encoder.json',
                    type=str, help='')
data_p.add_arg("-vocab_bpe_file",
                    default='src/data_preprocess/config/bpe/gpt2_bpe/vocab.bpe',
                    type=str, help='')

data_p.add_arg("-test_src", default='src/data_preprocess/data/example.source', type=str, help='')
data_p.add_arg("-test_tgt", default='src/data_preprocess/data/example.target', type=str, help='')

data_p.add_arg("-shard_size", default=2000, type=int, help='')
data_p.add_arg('-min_nsents', default=5, type=int, help='')
data_p.add_arg('-max_nsents', default=100, type=int, help='')
data_p.add_arg('-min_src_ntokens', default=5, type=int, help='')
data_p.add_arg('-max_src_ntokens', default=768, type=int, help='')
data_p.add_arg('-sim_threshold', default=0.1, type=float, help='')

data_p.add_arg("-lower", type=str2bool, nargs='?', const=True, default=True, help='')
data_p.add_arg('-dataset', default='test', type=str, help='train, valid or test, default will process all datasets')
data_p.add_arg('-n_cpus', default=20, type=int, help='')

data_p.add_arg("-sim_function", default='tf-idf', type=str, help='tf-idf or lsi or lda')
data_p.add_arg('-num_topics', default=20, type=int, help='')
data_p.add_arg("-find_opt_num", type=str2bool, nargs='?', const=True, default=False, help='')
data_p.add_arg("-process_wiki", type=str2bool, nargs='?', const=True, default=False, help='')

data_p.add_arg("-summary_sent_num", type=int, default=30, help='')
data_p.add_arg("-label_selection_type", default='greedy_selection', type=str, help='')
