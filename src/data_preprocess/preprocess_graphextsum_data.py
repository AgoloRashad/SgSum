...
import os
import sys
sys.path.append("/content/drive/MyDrive/EMNLP2021-SgSum/src/data_preprocess")
...
def do_format_to_json(args):
    ...
    print(time.clock())
    data_builder_graphextsum.format_to_json_infernce(args)
    print(time.clock())
...
def do_format_to_paddle(args):
    ...
    print(time.clock())
    data_builder_graphextsum.format_to_paddle_infernce(args)
    print(time.clock())
